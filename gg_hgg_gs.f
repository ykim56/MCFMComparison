...
c                                                                      *
c     f(-p1)+f(-p2) -->  H + parton(p5) + parton(p6) + parton(p7)      *
c                        |                                             *
c                        --> b(p3)+bbar(p4)                            *
c                                                                      *
c***********************************************************************
...
c***********************************************************************
      if (  ((j > 0).and.(k > 0).and.qb1.and.qb2)
     & .or. ((j < 0).and.(k < 0).and.ab1.and.ab2)) then
...
c***********************************************************************
      elseif (  ((j > 0).and.(k < 0).and.qb1.and.ab2)
     &     .or. ((j < 0).and.(k > 0).and.ab1.and.qb2)) then
...
c Old implementation -- changed in order to match qqb -> gg structure
c      msq(21,j,k)=msq(21,j,k)+two*real(nflav,dp)*f4q*(
c     &+(msq_struc56_7(igg_ab,m,n)+msq_struc56_7(igg_ba,m,n)
c     & +msq_struc56_7(igg_sym,m,n))*sub56_7(gq)
c     &-(msq_struc56_7v(igg_ab,m,n)+msq_struc56_7v(igg_ba,m,n)
c     & +msq_struc56_7v(igg_sym,m,n))*sub56_7v)

c--- note that all subtractions are performed with reference to the
c--- quark-antiquark matrix elements. We could call the antiquark-quark
...
c--- 1/2019: added 16 and 17 explicitly (with weight 1/2) for manifest symmetry
      msq(11,j,k)=msq(11,j,k)+half*real(nflav,dp)*f4q*(
     &+(msq_struc16_5(igg_ab,m,n)+msq_struc16_5(igg_sym,m,n))*sub56_1(gq)
     &-(msq_struc56_1v(igg_ab,m,n)+msq_struc56_1v(igg_sym,m,n))*sub56_1v)

      msq(14,j,k)=msq(14,j,k)+half*real(nflav,dp)*f4q*(
     &+(msq_struc26_5(igg_ba,m,n)+msq_struc26_5(igg_sym,m,n))*sub56_2(gq)
     &-(msq_struc56_2v(igg_ba,m,n)+msq_struc56_2v(igg_sym,m,n))*sub56_2v)

      msq(16,j,k)=msq(16,j,k)+half*real(nflav,dp)*f4q*(
     &+(msq_struc25_6(igg_ba,m,n)+msq_struc25_6(igg_sym,m,n))*sub65_2(gq)
     &-(msq_struc65_2v(igg_ba,m,n)+msq_struc65_2v(igg_sym,m,n))*sub65_2v)

      msq(17,j,k)=msq(17,j,k)+half*real(nflav,dp)*f4q*(
     &+(msq_struc15_6(igg_ab,m,n)+msq_struc15_6(igg_sym,m,n))*sub65_1(gq)
     &-(msq_struc65_1v(igg_ab,m,n)+msq_struc65_1v(igg_sym,m,n))*sub65_1v)

c--- 1/2019: added 21 and 24 explicitly (with weight 1/2) for manifest symmetry
      msq(21,j,k)=msq(21,j,k)+half*real(nflav,dp)*f4q*(
     &+(msq_struc56_7(igg_ab,m,n)+msq_struc56_7(igg_ba,m,n))*sub56_7(gq)
     &-(msq_struc56_7v(igg_ab,m,n)+msq_struc56_7v(igg_ba,m,n))*sub56_7v)

      msq(24,j,k)=msq(24,j,k)+half*real(nflav,dp)*f4q*(
     &+(msq_struc65_7(igg_ab,m,n)+msq_struc65_7(igg_ba,m,n))*sub65_7(gq)
...
c*********************************
     ...
     & msq_struc15_7(igg_ba,m,n),msq_struc15_7(igg_sym,m,n),
     & sub75_1(gg),
     & msq_struc75_1v(igg_ba,m,n),msq_struc75_1v(igg_sym,m,n),sub75_1v)
      msq(15,j,k)=msq(15,j,k)+two*f2q/three*sub2q3g_fi(
     & msq_struc15_7(igg_ba,m,n),msq_struc15_7(igg_sym,m,n),
     & sub15_7(qq))

      msq(18,j,k)=msq(18,j,k)+f2q/three*sub2q3g_if(
     & msq_struc25_7(igg_ab,m,n),msq_struc25_7(igg_sym,m,n),
     & sub75_2(gg),
     & msq_struc75_2v(igg_ab,m,n),msq_struc75_2v(igg_sym,m,n),sub75_2v)
      msq(18,j,k)=msq(18,j,k)+two*f2q/three*sub2q3g_fi(
     & msq_struc25_7(igg_ab,m,n),msq_struc25_7(igg_sym,m,n),
     & sub25_7(qq))

      msq(17,j,k)=msq(17,j,k)+f2q/three*sub2q3g_if(
     & msq_struc15_6(igg_ab,m,n),msq_struc15_6(igg_sym,m,n),
     & sub65_1(gg),
     & msq_struc65_1v(igg_ab,m,n),msq_struc65_1v(igg_sym,m,n),sub65_1v)
     ...
     & msq_struc25_6(igg_ba,m,n),msq_struc25_6(igg_sym,m,n),
     & sub65_2(gg),
     & msq_struc65_2v(igg_ba,m,n),msq_struc65_2v(igg_sym,m,n),sub65_2v)
...
c***********************************************************************
      elseif (  ((j > 0).and.(k == 0).and.qb1.and.gb2)
     &     .or. ((j < 0).and.(k == 0).and.ab1.and.gb2)) then
...
c***********************************************************************
      elseif (  ((j == 0).and.(k > 0).and.gb1.and.qb2)
     &     .or. ((j == 0).and.(k < 0).and.gb1.and.ab2)) then
...
c---  and we need "two" to remove unnecessary identical particle factor
...
c---  iqq_b = iqq_a (5 <--> 6) and we want qQ->Qq and not qQ->qQ
c---  and we need "two" to remove unnecessary identical particle factor
      msq(3,j,k)=msq(3,j,k)+two*real(nflav-1,dp)*f4q*(
...
c--- is artificially stored in msq_struc(iqr,0,0)
      msq(3,j,k)=msq(3,j,k)+half*f4q*(
     &  msq_struc16_2(iqr,0,0))*sub16_2(qg)
...
c***********************************************************************
      elseif ((j == 0).and.(k == 0) .and. gb1 .and. gb2) then
c*******************************
c Note that in the sum over    *
c permutations below, factors  *
c of 1/2 enter for 56, 57, 67  *
